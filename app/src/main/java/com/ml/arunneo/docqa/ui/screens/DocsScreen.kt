package com.ml.arunneo.docqa.ui.screens
...
import com.ml.arunneo.docqa.ui.components.AppAlertDialog
import com.ml.arunneo.docqa.ui.components.createAlertDialog
import com.ml.arunneo.docqa.ui.theme.DocQATheme
import com.ml.arunneo.docqa.ui.viewmodels.DocsViewModel
            ...
            it.data?.data?.let { uri ->
                ...
                context.contentResolver.openInputStream(uri)?.let { inputStream ->
                    ...
                    CoroutineScope(Dispatchers.IO).launch {
                        docsViewModel.documentsUseCase.addDocumentLangChain(
                            inputStream,
                            docFileName,
                            docType
                        )
